 ...
 * @returns
 */
export const winRateCalculate = (
  wins: number,
  loose: number,
  deciamlPoint: number = 2
) => {
 ...
 * @returns
 */
export const killInvolveCalculate = (
  kills: number,
  assists: number,
  ourTeamKill: number,
  deciamlPoint: number = 2
 ...
 * @returns
 */
export const postionPlayCalculate = (
  games: number,
  totalGames: number,
  deciamlPoint: number = 0
) => {
  // 9 x 100 / 20 = 45
